...
def main():
   ...
   # Yesterday date
    ...
    number_of_pr_merged = stat_container[0]
    number_of_failed_pr = str(-1)
    number_of_waiting_pr = str(-1)
    number_of_successful_mm = str(-1)
    ...
    NUMBER_OF_FAILED_PRs = "["+number_of_failed_pr+"]"+"(https://github.com/trilinos/Trilinos/pulls?q=is%3Apr+merged%3A"+str(yesterday)+"T12%3A00%3A00-07%3A00.."+str(today)+"T12%3A00%3A00-07%3A00+base%3Adevelop)"
    NUMBER_OF_PRs_WAITING = "["+number_of_waiting_pr+"]"+"(https://github.com/trilinos/Trilinos/pulls?q=is%3Apr+merged%3A"+str(yesterday)+"T12%3A00%3A00-07%3A00.."+str(today)+"T12%3A00%3A00-07%3A00+base%3Adevelop)"
    NUMBER_SUCCESSFUL_MM = "["+number_of_successful_mm+"]"+"(https://github.com/trilinos/Trilinos/pulls?q=is%3Apr+merged%3A"+str(yesterday)+"T12%3A00%3A00-07%3A00.."+str(today)+"T12%3A00%3A00-07%3A00+base%3Adevelop)"
    JIRA_TICKETS = "["+number_of_successful_mm+"]"+"(https://sems-atlassian-son.sandia.gov/jira/browse/TRILFRAME-435)"
    ...
    writer = ptw.MarkdownTableWriter(
          ...
          value_matrix=[
                [str(today), pr_status[0], NUMBER_OF_PRs_MERGED, NUMBER_OF_FAILED_PRs, NUMBER_OF_PRs_WAITING, 70 , mm_status[1], NUMBER_SUCCESSFUL_MM, JIRA_TICKETS]
